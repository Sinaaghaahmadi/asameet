...
export const metadata: Metadata = {
  metadataBase: new URL(
    process.env.NEXT_PUBLIC_APP_URL || "https://asatalk.vercel.app",
  ),
  ...
  icons: {
    icon: [
      ...
      {
        url: `${bp}/asatalk/icons/favicon-32.png`,
        sizes: "32x32",
        type: "image/png",
      },
    ],
  ...
  openGraph: {
    ...
    description:
      "پیام‌رسان و تماس صوتی و تصویری خانوادهٔ آسا — سریع، شیشه‌ای، خودمانی.",
