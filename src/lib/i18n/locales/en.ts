...
export const en: typeof fa = {
  ...
  talk: {
    ...
    onboard: {
      ...
      langSub: "زبان خود را انتخاب کنید",
      continueBtn: "Continue",
      start: "Get started",
      haveAccount: "I have an account — log in",
      signinTitle: "Sign in to Asatalk",
      signinSub: "Enter your phone number or email; we'll detect which.",
      identifier: "Phone number or email",
      detectedPhone: "Phone number detected",
      detectedEmail: "Email detected",
      getCode: "Get verification code",
      or: "or",
      qr: "Log in with QR from another device",
      password: "Log in with username & password",
      terms: "By continuing you accept the Terms of Use and Privacy Policy.",
      otpTitle: "Enter the code",
      otpSentTo: "A 6-digit code was sent to {id}.",
      change: "Change number",
      resendIn: "Resend in",
      resend: "Resend",
      demoCode: "Demo mode: your code is",
      whoTitle: "Who are you?",
      whoSub: "Write your name; the photo is optional.",
      name: "Full name",
      ...
      allow: "Allow",
      qrTitle: "Log in with a QR code",
      qrSub: "Scan this code with a device you are already signed in on.",
      qrStep1: "Open Asatalk on the signed-in phone",
      qrStep2: "Settings → Devices → Scan QR code (or use the phone's camera)",
      qrStep3: "Scan this code and confirm",
      qrExpired: "Code expired — get a new one",
      qrApproveTitle: "Log this device in?",
      qrApproveSub: "If you did not ask for this, reject it.",
      qrApproved: "Device signed in",
      qrRejected: "Request rejected",
      qrScan: "Scan QR code",
      qrManual: "Enter the code manually",
      qrNeedLogin: "Sign in first to approve this device.",
      approve: "Approve and sign in",
      reject: "Reject",
      wrongCode: "Wrong code",
      slide1: "Fast messaging with glass bubbles",
      slide2: "Reliable voice and video calls",
      slide3: "Groups, channels and custom folders",
      slide4: "Several accounts in one app",
    },
    home: {
      title: "Asatalk",
      status: "Status",
      ...
      minutesAgo: "min ago",
      justNow: "just now",
      version: "Asatalk 2.4.0",
    },
    conv: {
      pinnedOf: "Pinned message {i} of {n}",
      seenBy: "Seen by {n}",
      admin: "admin",
      owner: "owner",
      videoNoteSent: "{name} sent a video message",
      listened: "listened",
      followers: "followers",
      views: "views",
      comments: "comments",
      ...
      soon: "Coming soon",
      chatTheme: "Theme for this chat",
      chatThemeHint: "Color and wallpaper apply only to this chat.",
      themeDefault: "Default",
      replyWithMessage: "Reply with message",
    ...
    pin: {
      ...
      setTitle: "Create a 6-digit PIN",
      confirmTitle: "Enter the PIN again",
      mismatch: "PINs do not match",
      wrong: "Wrong PIN",
      biometric: "Unlock with fingerprint",
      forgot: "Forgot your PIN?",
      forgotHint: "Logging out and back in clears the PIN.",
      enable: "PIN lock",
      enableHint: "Ask for the PIN every time Asatalk opens.",
      removed: "PIN lock removed",
      set: "PIN lock enabled",
    },
    onboarding: {
      s1Title: "Asatalk",
      s1Desc:
    ...
    composer: {
      ...
      recording: "Recording…",
      recent: "Recent",
      tooLarge: "File is larger than 3 MB",
