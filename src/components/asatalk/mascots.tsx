...
export function Mascot({
  ...
  const spark = (
    <g className={anim("asa-spark")}>
      <path
        d="M100 8 l4.5 11 11 4.5 -11 4.5 -4.5 11 -4.5-11 -11-4.5 11-4.5z"
        fill={`url(#${id}-spark)`}
      />
    </g>
  );
    ...
    switch (pose) {
        ...
        return (
          <>
            <g className={anim("tg-heartbeat")} transform="translate(0 -2)">
              <path
                d="M78 96 c-9-11-26-4-22 9 3 10 13 15 22 24 9-9 19-14 22-24 4-13-13-20-22-9z"
                fill="#e11d48"
              />
              <path
                d="M122 96 c-9-11-26-4-22 9 3 10 13 15 22 24 9-9 19-14 22-24 4-13-13-20-22-9z"
                fill="#e11d48"
              />
            ...
            <g className={anim("tg-confetti")}>
              <path
                d="M52 44 l3 7 7 3 -7 3 -3 7 -3-7 -7-3 7-3z"
                fill="#fb7185"
              />
      ...
      case "angry":
        return (
          <>
            <path
              d="M62 88 l26 12 M138 88 l-26 12"
              stroke={INK}
              strokeWidth="6"
              strokeLinecap="round"
            />
      ...
      default:
        return (
          <>
            {eyes}
            {pose === "search" || pose === "lock" || pose === "bell"
              ? softSmile
              : smile}
          </>
        );
      ...
      case "lock":
        return (
          <g>
            ...
            />
            <path
              d="M167 86 v-11 a13 13 0 0 1 26 0 v11"
              stroke="#92400e"
              strokeWidth="6"
              fill="none"
            />
      ...
      case "phone":
        return (
          <g className={anim("tg-ring-shake")}>
            ...
            <path
              d="M200 70 q10 8 10 22 M207 60 q16 12 16 32"
              stroke={`oklch(0.7 0.15 ${h})`}
              strokeWidth="4"
              strokeLinecap="round"
              fill="none"
            />
      ...
      case "bell":
        return (
          <g className={anim("tg-ring-shake")}>
            ...
            />
            <path
              d="M178 62 a17 17 0 0 1 17 17 v14 l7 9 h-48 l7-9 v-14 a17 17 0 0 1 17-17z"
              fill="#fbbf24"
            />
      ...
      case "thumbs":
        return (
          <g className={anim("tg-bounce")}>
            ...
            />
            <path
              d="M166 112 h-8 v-24 h8z M170 88 l8 -20 q6 -4 8 4 l-2 16 h14 q8 0 6 8 l-6 20 q-2 6 -8 6 h-20z"
              fill={hand}
              stroke={arm}
              strokeWidth="3"
              strokeLinejoin="round"
  ...
  return (
    <svg
      ...
      className={cn(
        "tg-mascot",
        animate && pose !== "sleep" && pose !== "party" && "tg-float",
        animate && pose === "party" && "tg-bounce",
        className,
      )}
      aria-hidden="true"
    >
      ...
      />
      <path
        d="M56 128 a44 44 0 0 1 88 -22 a70 70 0 0 0 -88 22z"
        fill={`url(#${id}-rim)`}
      />
      <rect
        x="62"
        ...
        <g>
          <g transform="translate(-52 46) scale(0.55)">
            <rect
              ...
              height="130"
              rx="48"
              fill={`oklch(0.7 0.17 ${typeof hue === "number" ? hue + 90 : "calc(var(--talk-h, 240) + 90)"})`}
            />
            <path
              d="M40 40 q58 -26 118 6"
              stroke={`oklch(0.7 0.17 ${typeof hue === "number" ? hue + 90 : "calc(var(--talk-h, 240) + 90)"})`}
              strokeWidth="21"
              strokeLinecap="round"
              fill="none"
            />
          ...
          <g transform="translate(120 46) scale(0.55)">
            <rect
              ...
              height="130"
              rx="48"
              fill={`oklch(0.72 0.17 ${typeof hue === "number" ? hue - 90 : "calc(var(--talk-h, 240) - 90)"})`}
            />
            <path
              d="M40 40 q58 -26 118 6"
              stroke={`oklch(0.72 0.17 ${typeof hue === "number" ? hue - 90 : "calc(var(--talk-h, 240) - 90)"})`}
              strokeWidth="21"
              strokeLinecap="round"
              fill="none"
            />
...
export function AsatalkLogo({
  ...
  return (
    ...
    >
      ...
      <path
        d="M118 402 L88 478 L188 428 Z"
        fill="oklch(0.48 0.17 var(--talk-h, 240))"
      />
      <path
        d="M256 32 a216 216 0 0 1 216 216 c0 18 -3 36 -8 52 C380 200 300 170 60 300 40 210 110 32 256 32z"
        fill={`url(#${id}-s)`}
      />
      <path
        d="M150 352 L256 140 L362 352 H312 L256 234 L200 352 Z"
        fill="#fff"
      />
